           ...
           <cell v-for="(item,index) in itemsList">
                <div class="information_content">
                    <div class="title_sourece_time">
                        <text class="text_title" @click="goAlertContent()">TTC Protocol（TTC）暂停上线公告TTC Protocol（TTC）暂停上线公告TTC Protocol（TTC）暂停上线公告</text>
                        <div class="source_time">
                            <text class="source" @click="goAlertFocus('default')">来源:bibox</text>
                            <div class="time_hit">
                                <div class="time_ago">
