<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        <image class="loading-bg" resize="contain" src="http://www.fintechawaken.com/img/logo.png"></image>
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">炒</text>
            <text ref="lTxt2" class="l-txt l-txt-2">币</text>
            <text ref="lTxt3" class="l-txt l-txt-3">有</text>
            <text ref="lTxt4" class="l-txt l-txt-4">风</text>
            <text ref="lTxt5" class="l-txt l-txt-5">险</text>
